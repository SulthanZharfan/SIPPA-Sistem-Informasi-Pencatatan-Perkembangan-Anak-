        ...
        return $table
            ...
            ->actions([
                ...
                Actions\Action::make('approve')
                    ...
                    ->action(function (PertemuanPerkembanganFisik $record) {
                        $record->update([
                            'status' => 'approved',
                            'approved_by' => auth()->id(),
                            'approved_at' => now(),
                        ...
                        // agar wali hanya lihat data yang sudah sah
                ...
                Actions\Action::make('revisi')
                    ...
                    ->color('warning')
                    ->visible(fn (PertemuanPerkembanganFisik $record) => $record->status !== 'rejected')
                    ->requiresConfirmation()
                    ->action(function (PertemuanPerkembanganFisik $record) {
                        $record->update([
                            'status' => 'rejected',
